...
interface InviteClientEmailProps {
  actionUrl: string;
}

export default function InviteClientEmail({ actionUrl }: InviteClientEmailProps) {
  return (
    <Html lang="es">
      <Tailwind config={{ presets: [pixelBasedPreset] }}>
        <Head />
        <Preview>Tu coach te ha invitado a FitMetrik</Preview>
        <Body className="bg-[#0a0f1e] font-sans m-0 py-10">
          <Container className="max-w-xl mx-auto p-8 border border-solid border-[#1e293b] rounded-2xl bg-[#0f172a]">
            ...
            <Text className="text-base text-[#e2e8f0] mb-6">
              Tu coach te ha creado una cuenta personal en FitMetrik para llevar el seguimiento de tu progreso y tener tus planes siempre a mano.
            </Text>
...
} satisfies InviteClientEmailProps;

export { InviteClientEmail };
